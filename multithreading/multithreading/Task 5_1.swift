...
class Task_5_1: UIViewController {
    ...
    private let taskLabel: UILabel = {
        let label = UILabel()
        label.text = "Почему так распечататлось. Заменить DispatchQueue.main.async на Task"
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        setupUI()
        //print(2), выполняется асинхронно на главной очереди после выполнения viewDidLoad()
    ...
    @objc func buttonPressed() {
        let nextViewController = Task_5_2()
