...
class ThreadPrintDemon2: Thread {
    override func main() {
        for _ in (0..<100) {
            print("1")
        }
...
class ThreadPrintAngel2: Thread {
    override func main() {
        for _ in (0..<100) {
            print("2")
        }
...
final class Task_2_2_2: UIViewController {
    ...
    private let taskLabel: UILabel = {
        let label = UILabel()
        label.text = "Выставить правильные приоритеты, чтобы сначала печатали 2, потом 1"
    ...
    @objc func buttonPressed() {
        let nextViewController = Task_2_2_3()
